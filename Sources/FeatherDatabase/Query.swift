...
public enum QueryBinding: Sendable, Equatable, Hashable, Codable {
    case string(String)
    case int(Int)
    case double(Double)
}

public struct OrderedBinding: Sendable, Equatable, Hashable, Codable {
...
public struct Query: DatabaseQuery {
    ...
    public var bindings: [OrderedBinding]
